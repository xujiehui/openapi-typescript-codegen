 ...
 */
export const getServices = (openApi: OpenApi, transformOperationName?: (url: string, method: string, operationId?: string) => string): Service[] => {
                ...
                if (path.hasOwnProperty(method)) {
                    switch (method) {
                        ...
                        case 'patch':
                            ...
                            tags.forEach(tag => {
                                const operation = getOperation(openApi, url, method, tag, op, pathParams, transformOperationName);
